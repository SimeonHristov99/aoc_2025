...
func TestCountZeroIntersections(t *testing.T) {
	...
	t.Run("when intersecting zero via subtraction once then returns one", func(t *testing.T) {
		// Arrange
		current := 12
		rotationDiff := -15
		expected := 1
	...
	t.Run("when intersecting zero via addition once then returns one", func(t *testing.T) {
		// Arrange
		current := 85
		rotationDiff := 22
		expected := 1
	...
	t.Run("when intersecting zero via addition once and ending at same point then returns one", func(t *testing.T) {
		// Arrange
		current := 85
		rotationDiff := 100
		expected := 1
...
func TestSolve(t *testing.T) {
	t.Run("when called with sample then returns part one result", func(t *testing.T) {
		...
		// Act
		actual, actualError := solve(file, countZeroEndpoints)
	...
	t.Run("when called with sample then returns part two result", func(t *testing.T) {
		...
		// Act
		actual, actualError := solve(file, countZeroIntersections)
